...
class HeaderItem(view: View) : HeaderLayout.ViewHolder(view) {
    ...
    private val headerBackgrounds = intArrayOf(R.drawable.stage, R.drawable.drama, R.drawable.music, R.drawable.dance, R.drawable.arts, R.drawable.ams, R.drawable.literature, R.drawable.gaming, R.drawable.card_1_background).toTypedArray()
    ...
    fun setContent(position: Int, title: TextView?, line: View?) {
        ...
        Glide.with(background).load(headerBackgrounds[position]).into(background)
